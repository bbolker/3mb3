---
title: "MATH 3MB3<br>Introduction to modeling<br>Winter 2017"
...
- *Teaching assistants*: **TBA** They will be running labs, marking homework, and assisting with projects. When emailing, *please allow at least one full business day for responses.* Please note also that **the TAs may not respond to emails sent less than 24hrs before any assessment (exam/homework/project).** The primary time to get help is during lab but, time permitting, the TA may be available for extra help outside of that hour.
...
- **Schedule:** Listed [here](https://bbolker.github.io/math3mb/admin/schedule.html). Key points:
...
- [Course website](https://bbolker.github.io/math3mb) Either you are already here or you need to write this down:
  `https://bbolker.github.io/mathmb3`. In some cases you may prefer to access files via the [course repository](https://github.com/bbolker/math3mb) (`https://github.com/bbolker/math3mb`).
- **Computer software and hardware:**  (Lab hours (see above) are reserved for students in this course and you have
    priority over students not registered in this course at that time.  However, you should also be able to work there outside of this
    allocated time-slot unless the computer lab has been reserved for some other course.) **I hope that it will be possible for students
    to bring (or share) a laptop for work during class sessions.** A backup device such as a memory stick is required in order to save
    your work.
- Class rules:
	1. respect others
...
There will be five homework assignments to hand in for marks (5% each). The due dates for these assignments are on the [course schedule](https://bbolker.github.io/math3mb/admin/schedule.html). Assignments are to be handed in before 11:59 PM on the day they are due. Send your assignment submission to the TA in an email with
